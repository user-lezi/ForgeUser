...
exports.UserProfileProperties = (0, defineProperties_1.default)({
    ...
    banner: (i) => i?.user.banner
        ? cdn(discord_js_1.CDNRoutes.userBanner(i.user.id, i.user.banner, i.user.banner.startsWith("a_") ? "gif" : "png"))
        : "",
    ...
    clanBadge: (i) => i?.user.clan?.badge
        ? cdn(discord_js_1.CDNRoutes.guildTagBadge(i.user.clan.identity_guild_id, i.user.clan.badge, i.user.clan.badge.startsWith("a_") ? "gif" : "png"))
        : "",
